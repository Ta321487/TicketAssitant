...
{
    public partial class ManualTicketInputWindow : Window
    {
        private readonly ManualTicketInputViewModel _viewModel;
        private ThemeService _themeService;
        private bool _isClosing = false; // 添加窗口关闭标志

        public ManualTicketInputWindow(DatabaseService databaseService, MainViewModel mainViewModel)
        {
            try
            {
                InitializeComponent();
                ...
                _viewModel = new ManualTicketInputViewModel(databaseService, mainViewModel);
                ...
                // 订阅窗口加载事件
                this.Loaded += ManualTicketInputWindow_Loaded;

                // 订阅字体大小变化事件
                this.SizeChanged += ManualTicketInputWindow_SizeChanged;
        ...
        private void ManualTicketInputWindow_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                // 设置窗口初始大小
        ...
        private void ManualTicketInputWindow_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            try
            {
                // 当窗口大小变化时，调整内容布局
