...
{
    /// <summary>
    /// AddStationsToRouteWindow.xaml 的交互逻辑
    /// </summary>
    public partial class AddStationsToRouteWindow : Window
    {
        private readonly AddStationsToRouteViewModel _viewModel;
        ...
        public AddStationsToRouteWindow(RouteInfo routeInfo, DatabaseService databaseService, StationSearchService stationSearchService, MainViewModel mainViewModel, Action refreshCallback)
        {
            InitializeComponent();
            ...
            // 初始化ViewModel
            _viewModel = new AddStationsToRouteViewModel(
                routeInfo,
                databaseService,
